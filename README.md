...
### 1. One-Way vs Two-Way Aeration

The Python-based two-way model was compared with the previously developed Excel-based one-way aeration model using the same general operating conditions.
...
* Layer-wise composting behavior

### 2. Layer-Wise Analysis

Because airflow direction is periodically reversed, opposite layers can experience comparable airflow conditions.

The model therefore examines the behavior of:

* Layer 1 vs Layer 6
* Layer 2 vs Layer 5
* Layer 3 vs Layer 4

This helps evaluate whether alternating airflow improves the uniformity of composting throughout the pile.

### 3. Aeration Cycle Analysis

Different airflow reversal periods can be tested using the `cycle_hours` parameter.
...
A shorter cycle causes the airflow direction to reverse more frequently, allowing the effect of reversal frequency on composting behavior to be investigated.
...
A shorter **24-hour aeration cycle** also produced a lower final compost mass (**316.7 kg**) compared with the 72-hour cycle (**332.2 kg**) under the investigated conditions.

---

## Visualizations

The model generates time-series results for the major composting parameters, including:

* Temperature profile across compost layers
* Moisture content variation
* Oxygen concentration
* Volatile solids degradation
* Initial vs final compost composition
* Layer-to-layer comparisons

Example figures generated by the project can be placed in the `results/` directory.

```text
results/
├── temperature_profile.png
├── moisture_profile.png
├── oxygen_profile.png
├── volatile_solids_profile.png
└── compost_composition.png
```
...
Determine Airflow Direction
       ↓
Select Layer Calculation Order
       ↓
Calculate Composting Variables
       ↓
Store Layer & Time Results
       ↓
Reverse Airflow After Cycle
       ↓
...
```text
two-way-forced-aeration-composting/
│
├── composting_model.ipynb
├── README.md
│
└── results/
    ├── temperature_profile.png
...
* Perform the composting simulation
* Calculate layer-wise variables
* Reverse airflow according to the selected cycle
* Generate the simulation results and figures

---

## Research Significance

This project demonstrates how a mathematical composting model can be translated into a **programming-based computational framework**.

Compared with a spreadsheet-based implementation, a Python model provides greater flexibility for:

* Repeated simulations
* Parameter sensitivity analysis
* Layer-wise calculations
* Changing aeration strategies
* Visualization
* Future model expansion

The framework can potentially be extended to investigate optimized aeration schedules, different airflow rates, sensor-based model calibration, and machine-learning-assisted process optimization.

---

## Limitations and Future Work

The current model is a computational simulation and does not replace experimental validation.

Future development could include:

* Testing a wider range of aeration cycle durations.
* Investigating different airflow rates.
* Incorporating experimental sensor data for model validation.
* Evaluating compost maturity and nutrient quality.
* Extending the model to second-stage composting.
* Integrating machine learning for process prediction and optimization.
...
This computational project was developed as part of research on **two-way forced aeration composting in a closed system**, with the objective of investigating how dynamic airflow direction influences the physical and biological behavior of composting.

**Focus areas:** Environmental Engineering · Solid Waste Management · Mathematical Modeling · Computational Simulation · Python
